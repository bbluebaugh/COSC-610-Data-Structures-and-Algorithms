...
public class MM {
    ...
    double matrix1[][];
    double matrix1Row, matrix2Column, matrix2Row, matrix1Column;
    double matrix2[][];
    double sum1[][];
    boolean flag = true;
    
    public void assignFirst(double row, double column, ArrayList<Double> arr){
        double counter = 0;
    ...
    public boolean calculateMatrix(){//calculate the matrix
        ...
        double multiply[][] = new double[matrix1Row][matrix2Column];//make a new matrix for the multiplication based on
